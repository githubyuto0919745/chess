...
public class MySqlGameDAO implements GameDataAccess {
    ...
    private GameData readGame(ResultSet rs) throws SQLException {
        ...
        String whiteUsername = rs.getString("gameName");
        String blackUsername = rs.getString("gameName");
    ...
    public GameData createGame(GameData game) {
        try (Connection connect = DatabaseManager.getConnection()){
            var table = "INSERT INTO auth (gameID, gameName, whiteUsername, blackUsername, game) VALUES (?,?,?)";
            try(PreparedStatement ps = connect.prepareStatement(table)){
