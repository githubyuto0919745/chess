...
public class PlayCommand {
    ...
    private final boolean isObserver;public PlayCommand(WebSocketFacade wsFacade, BoardDesign boardDesign, String authToken, Integer gameID, ChessGame game, boolean isObserver) {
    ...
    return switch (col.toLowerCase()) {
        case "a" -> 1; case "b" -> 2; case "c" -> 3; case "d" -> 4; case "e" -> 5; case "f" -> 6; case "g" -> 7;case "h" -> 8;
